...
class Login extends Front {
    ...
    public function register()
    {
        ...
        \CI::form_validation()->set_rules('screen_name', 'lang:account_screenname', 'trim|required|max_length[32]');
        ...
        \CI::form_validation()->set_rules('zip', 'lang:account_zip', 'trim|required|max_length[5]');
        ...
        {
            $save['id'] = false;
            $save['screen_name'] = \CI::input()->post('screen_name');
            ...
            $save['birthday'] = date_format($date, 'Y-m-d');
            
            $save['gender'] = intval((bool)\CI::input()->post('gender'));
            ...
            $save['zipcode'] = \CI::input()->post('zip');
            
            $save['password']  = sha1(\CI::input()->post('password'));
            
            //if they're automatically activated log them in
            $save['active'] = 1;
