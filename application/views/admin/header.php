...
<title>Unismoke.com<?php echo (isset($page_title))?' :: '.$page_title:''; ?></title>
...
<link href="<?php echo base_url('assets/css/file_manager/jquery.fancybox.css');?>" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url('assets/css/file_manager/dropzone.min.css');?>" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo base_url('assets/js/file_manager/jquery.fancybox.js');?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/file_manager/dropzone.min.js');?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/ntc.js');?>"></script>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('admin');?>">Unismoke.com</a>
            </div>
